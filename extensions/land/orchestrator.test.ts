...
function pr(sha: string, state = "OPEN"): string { return JSON.stringify({ number: 7, url: "https://github.com/o/r/pull/7", title: "x", state, isDraft: false, headRefName: "feature", baseRefName: "main", headRefOid: sha, mergeable: "MERGEABLE", mergeStateStatus: "CLEAN", mergedAt: state === "MERGED" ? "2026-01-01" : null, mergeCommit: state === "MERGED" ? { oid: "c".repeat(40) } : null }); }
