...
export function collectScope(
	...
	push(
		[
			...
			"Review root: current working directory (`.`)",
			"All repository paths in this bundle are relative to that review root.",
			"The live source workspace is not part of the reviewer-visible tree.",
			`HEAD: ${headSha}`,
